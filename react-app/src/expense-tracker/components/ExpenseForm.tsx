...
const schema = z.object({
  description: z.string().min(3, {message: "Description should be at least 3 chars"}).max(50),
  amount: z.number({ invalid_type_error: "Amout is Required"}).min(0.01).max(1000000),
